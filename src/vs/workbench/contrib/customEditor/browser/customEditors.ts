...
import { contributionPoint } from 'vs/workbench/contrib/customEditor/browser/webviewEditor.contribution';
...
import { IWebviewService, WebviewEditorOverlay } from 'vs/workbench/contrib/webview/common/webview';
